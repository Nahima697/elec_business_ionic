...
onSubmit() {
  ...
  if (this.ruleForm.valid && stationId) {
    ...
    const newRule: AvailabilityRuleDTO = {
      // On remplit stationId pour le POST (attendu par ton DTO Java)
      stationId: stationId,

      // On s'assure que c'est bien un nombre simple
      dayOfWeek: Number(formValue.dayOfWeek),

      // Ajout des secondes si nécessaire pour LocalTime Java (ex: "10:00" -> "10:00:00")
